...
public class LeaderboardF extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leaderboardf);
        ...
        try {
            ...
            backToMain.setOnClickListener(v -> {
                Intent intent = new Intent(LeaderboardF.this, MainMenu.class);
                startActivity(intent);
            });
            Button local = findViewById(R.id.local);
            local.setOnClickListener(v -> {
                Intent intent = new Intent(LeaderboardF.this, Leaderboard.class);
                startActivity(intent);
            });
            Button global = findViewById(R.id.global);
            global.setOnClickListener(v -> {
                Intent intent = new Intent(LeaderboardF.this, LeaderboardG.class);
                startActivity(intent);
            });
        }
    }
