...
public class LeaderboardFSP extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leaderboardfsp);

        // Read the CSV file from the raw folder
        InputStream inputStream = getResources().openRawResource(R.raw.leaderboardf);
        ...
        try {
            ...
            backToMain.setOnClickListener(v -> {
                Intent intent = new Intent(LeaderboardFSP.this, MainMenuSP.class);
                startActivity(intent);
            });
            Button local = findViewById(R.id.local);
            local.setOnClickListener(v -> {
                Intent intent = new Intent(LeaderboardFSP.this, LeaderboardSP.class);
                startActivity(intent);
            });
            Button global = findViewById(R.id.global);
            global.setOnClickListener(v -> {
                Intent intent = new Intent(LeaderboardFSP.this, LeaderboardGSP.class);
                startActivity(intent);
            });
        }
    }
